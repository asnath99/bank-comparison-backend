...
export const AddBankForm = ({ onSubmit, isSubmitting }: AddBankFormProps) => {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="ex: Banque Globale" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="ex: SN pour Sénégal" {...field} />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="https://www.banqueglobale.com" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <Button type="submit" disabled={isSubmitting}>
          {isSubmitting ? 'Envoi en cours...' : 'Ajouter la banque'}
        </Button>
      </form>
    </Form>
  );
